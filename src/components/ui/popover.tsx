...
function PopoverHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      className={cn(
        'flex w-full flex-col gap-1 rounded-t-xl border-b border-surface-border px-3 py-2',
        className,
      )}
      {...props}
    />
...
function PopoverFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      className={cn(
        'mt-auto grid w-full gap-2 rounded-b-xl border-t border-surface-border px-3 py-2',
        className,
      )}
      {...props}
    />
