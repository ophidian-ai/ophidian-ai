...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    ...
    "--rainbow":
      "repeating-linear-gradient( 0deg,rgb(13,177,178) calc(var(--step) * 1),rgba(57,255,20,1) calc(var(--step) * 2),rgba(61,203,204,1) calc(var(--step) * 3),rgba(131,255,247,1) calc(var(--step) * 4),rgba(13,177,178,1) calc(var(--step) * 5),rgb(57,255,20) calc(var(--step) * 6),rgb(13,177,178) calc(var(--step) * 7) ) 0% var(--bg-y)/200% 700% no-repeat",
    "--diagonal":
      "repeating-linear-gradient( 128deg,#0D1B2A 0%,hsl(174,10%,60%) 3.8%,hsl(174,10%,60%) 4.5%,hsl(174,10%,60%) 5.2%,#0D1B2A 10%,#0D1B2A 12% ) var(--bg-x) var(--bg-y)/300% no-repeat",
    "--shade":
  ...
  return (
    ...
    >
      <div className="h-full grid will-change-transform origin-center transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] [transform:rotateY(var(--r-x))_rotateX(var(--r-y))] rounded-[var(--radius)] border border-primary/20 hover:[--opacity:0.6] hover:[--duration:200ms] hover:[--easing:linear] hover:filter-none overflow-hidden">
