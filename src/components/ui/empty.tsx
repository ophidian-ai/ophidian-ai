  ...
  "flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        icon: "relative flex size-9 shrink-0 items-center justify-center rounded-md border border-primary/20 bg-surface text-foreground shadow-sm",
      },
    },
    defaultVariants: {
      variant: "default",
...
function EmptyDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <div
      ...
      className={cn(
        "text-sm/relaxed text-foreground-muted [[data-slot=empty-title]+&]:mt-1",
        className
      )}
      {...props}
    />
