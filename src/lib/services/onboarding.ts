      ...
      <div style="max-width: 600px; margin: 0 auto; background: #161616; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 30px; color: #E0E0E0; line-height: 1.6;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${setupLink}" style="background: #C4A265; color: #0F1F14; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: bold; display: inline-block;">Set Up Your Account</a>
          </div>
