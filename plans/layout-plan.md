...
Always take these layouts and UI effects and apply the OphidianAI brandin to them. Spin everything up on a dev server once finish and do not push to the github repository until instructed to do so.

### Projects Carousel:

This will be used within the "Projects Gallery" page where clients may explore past projects. Each card will link to the actual site that was created for that project so that they can explore the entire site.
...
All cards should have this effect from snippet 1 and the tipping effect from snippet 2.
...
This will be used for all forms including creating a verification process when signing in from a new device.
